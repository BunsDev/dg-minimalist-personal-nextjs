...
export const Config = {
  ...
  Experience: [
    ...
    },
    {
      ...
      setup: "Remote",
      startup: true,
      desc: "Collaborated closely with CEO and CTO co-founders to develop their MVP using Next.js, Expo, and React Native.",
    },
    {
  ...
  Projects: [
    ...
    },
    {
      ...
      desc: "A lightweight custom Discord Rich Presence manager. Compatible with Linux and Windows, with over 1000+ downloads. ",
